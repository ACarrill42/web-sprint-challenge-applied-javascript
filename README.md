...
1. What is the DOM?
    ...
    The DOM is the Document Object Model, and it is an object representation of the HTML elements of a webpage.

2. What is an event?

    An event occurs whenever the user does anything with the browser. ie click,move mouse, keydown, etc.

3. What is an event listener?

    An event listener is a piece of code that "listens" for the event that you tell it to listen for, and executes code when that event happens.

4. Why would we convert a NodeList into an Array?

    So you can use array methods on the list, which you cannot do in it's normal state.

5. What is a component?

    A component is a piece of reusable code that is DRY, consists of HTML/CSS/JS, and is modular.
